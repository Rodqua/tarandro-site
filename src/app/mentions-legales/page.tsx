...
export const metadata: Metadata = {
  ...
  description:
    "Mentions légales, informations légales et conditions d'utilisation du site Tarandro.org",
  robots: {
    index: false,
    follow: true,
  },
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 space-y-8">
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-2">
                <p>
                  <strong>Raison sociale :</strong> Tarandro
                </p>
                <p>
                ...
                <p>
                  <strong>Siège social :</strong> 17 Av. Professeur Horatio
                  Smith, 14000 Caen
                </p>
                <p>
                  <strong>SIRET :</strong> 949 495 204 00016
                </p>
                <p>
                  <strong>RCS :</strong> 949 495 204 R.C.S. Caen
                </p>
                <p>
                  <strong>TVA Intracommunautaire :</strong> FR17949495204
                </p>
                <p>
                  <strong>Téléphone :</strong> 06 33 28 91 61
                </p>
                <p>
                  <strong>Email :</strong>{" "}
                  <a
                ...
                <p>
                  <strong>Directeur de la publication :</strong> Quentin
                  TARANDRO
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                ...
                <p>
                  Les marques citées sur ce site sont déposées par les sociétés
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                ...
                <p>
                  ...
                  Données (RGPD) et à la loi Informatique et Libertés, nous
                  collectons uniquement les données personnelles nécessaires au
                ...
                <p>
                  Vos données sont conservées pendant une durée maximale de 3
                  ans à compter de notre dernier contact, conformément aux
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>
                    ...
                    des données vous concernant sont traitées et en obtenir une
                    copie
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Droit à l'effacement :</strong> obtenir l'effacement
                    de vos données dans certains cas
                  </li>
                  <li>
                    <strong>Droit à la limitation :</strong> obtenir la
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                <p>
                  ...
                  fonctionnement (cookies de session pour l'administration).
                </p>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                ...
                <p>
                  Tarandro ne pourra être tenu responsable des dommages directs
                  et indirects causés au matériel de l'utilisateur lors de
                  l'accès au site, et résultant soit de l'utilisation d'un
                  matériel ne répondant pas aux spécifications indiquées, soit
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                ...
                <p>
                  En cas de litige et à défaut d'accord amiable, le tribunal
                  compétent sera celui du ressort du siège social de Tarandro.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-2">
                <p>
                  <strong>Conception et développement :</strong> Tarandro
                </p>
                <p>
                  <strong>Hébergement :</strong> Vercel
                </p>
                <p>
                  <strong>Icônes :</strong> React Icons
                </p>
              </div>
            </div>
