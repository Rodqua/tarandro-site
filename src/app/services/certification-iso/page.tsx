...
export const metadata: Metadata = {
  ...
  description:
    "Expert en certification ISO pour votre entreprise. Accompagnement complet de l'audit initial à la certification : ISO 9001, 14001, 45001, 27001. Taux de réussite 95%.",
  keywords: [
    "certification ISO",
    "ISO 9001",
    "ISO 14001",
...
const isoNorms = [
  {
    ...
    description:
      "La norme de référence pour améliorer la satisfaction client et optimiser vos processus",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Démontrez votre engagement environnemental et réduisez votre impact écologique",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Protégez vos collaborateurs et créez un environnement de travail sûr",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Sécurisez vos données et protégez votre système d'information",
    benefits: [
...
const processSteps = [
  {
    ...
    description:
      "Audit de votre organisation et analyse des écarts par rapport aux exigences de la norme",
  },
  {
    number: "02",
    title: "Plan d'Actions",
    description:
      "Définition d'un plan d'actions personnalisé avec planification et allocation des ressources",
  },
  {
    number: "03",
    title: "Mise en Conformité",
    description:
      "Accompagnement dans l'adaptation de vos processus et la mise en place du système de management",
  },
  {
    number: "04",
    title: "Documentation",
    description:
      "Création et structuration de votre documentation qualité (manuel, procédures, instructions)",
  },
  {
    number: "05",
    title: "Formation",
    description:
      "Formation de vos équipes aux exigences de la norme et aux nouveaux processus",
  },
  {
    number: "06",
    title: "Audit Blanc",
    description:
      "Simulation de l'audit de certification pour identifier les derniers points d'amélioration",
  },
  {
    number: "07",
    title: "Certification",
    description:
      "Accompagnement lors de l'audit de certification par l'organisme accrédité",
  },
  {
    number: "08",
    title: "Suivi",
    description:
      "Accompagnement post-certification pour le maintien et l'amélioration continue",
  },
];
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    <strong>Accompagnement sur-mesure :</strong> Chaque
                    entreprise est unique, notre approche aussi
                  </span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle
                  ...
                  />
                  <span className="text-gray-700">
                    <strong>Experts certifiés :</strong> Consultants qualifiés
                ...
                <li className="flex items-start">
                  ...
                  />
                  <span className="text-gray-700">
                    <strong>Approche pragmatique :</strong> Solutions
                    opérationnelles adaptées à votre réalité
                  </span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle
                  ...
                  />
                  <span className="text-gray-700">
                    <strong>Suivi post-certification :</strong> Nous restons à
                    vos côtés après l'obtention du certificat
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-primary-100 mb-8">
              Diagnostic gratuit de votre organisation et devis personnalisé
              sous 48h
            </p>
