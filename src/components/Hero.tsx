...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-primary-50 via-white to-primary-100 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-secondary-200 rounded-full filter blur-3xl opacity-20 translate-y-1/2 -translate-x-1/2 animate-float" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-4 py-20 lg:py-32 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center bg-white px-4 py-2 rounded-full shadow-lg mb-8 animate-scaleIn hover:scale-105 transition-transform duration-300">
            ...
            <span className="text-sm font-medium text-gray-700">Expert certifié qualité & formation</span>
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 animate-fadeInUp leading-tight">
            Accompagnement Qualité & <span className="gradient-text">Formation Professionnelle</span>
          </h1>

          {/* Subtitle avec mots-clés */}
          <p className="text-xl md:text-2xl text-gray-600 mb-8 animate-fadeInUp animate-delay-100">
            Certifications <strong className="text-primary-600">ISO, HAS, PSAD</strong> • Formation <strong className="text-secondary-600">Bureautique & SST</strong>
          </p>

          <p className="text-lg text-gray-700 mb-12 max-w-3xl mx-auto animate-fadeInUp animate-delay-200">
            Optimisez votre démarche qualité et développez les compétences de vos équipes
            avec un accompagnement personnalisé et des formations certifiées.
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            <div className="text-center animate-fadeInUp animate-delay-300 group cursor-default">
              <div className="text-3xl md:text-4xl font-bold text-primary-600 mb-2 group-hover:scale-110 transition-transform">10+</div>
              <div className="text-sm text-gray-600">Années d'expérience</div>
            </div>
            <div className="text-center animate-fadeInUp animate-delay-400 group cursor-default">
              <div className="text-3xl md:text-4xl font-bold text-primary-600 mb-2 group-hover:scale-110 transition-transform">100+</div>
